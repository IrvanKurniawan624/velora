...
> **Note:** This guide documents the legacy speculative-routing benchmark
> harness. The current zero-token submission is described in the main
> [`README.md`](../README.md). Some commands below reference the retired `app/`
> engine and helper scripts; adapt them to the current `agent/` codebase as
> needed.
